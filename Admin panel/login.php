...
if(isset($_POST['btn'])){
    $email = $_POST['mail'];
    $pass=$_POST['paswrd'];
    $qry = "SELECT * FROM `admin` WHERE Aemail = '$email' AND Apassword = '$pass'";
    $run = mysqli_query($conn,$qry);
    while($f = mysqli_fetch_array($run)){
        $_SESSION['name'] = $f[1];
        header("location:index.php");
        echo"logged in";
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4" name="btn">Log In</button>
